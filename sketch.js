...
function preload(){
  ...
  mainRacerImg1 = loadAnimation("download (1).png","download.png");
  mainRacerImg2= loadAnimation("download (2).png");
  
  oppPink1Img = loadImage("download (3).png");
  oppPink2Img = loadAnimation("opponent3.png");
  
  oppYellow1Img = loadImage("download (4).png");
  oppYellow2Img = loadAnimation("opponent6.png");
  
  oppRed1Img = loadImage("download (5).png");
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    textSize(30);
    fill(600);
    text("Pressione pra cima pra reiniciar ",430,200);
